...
Config { font    = "xft:Noto Sans:pixelsize=14:antialias=true:hinting=true"
       ...
       , sepChar = "%"
       , alignSep = "}{"
       , template = " }{<fc=#8BE9FD> %cpu% </fc><fc=#666666>| </fc><fc=#ed8bad>%memory% </fc><fc=#666666>| </fc><fc=#FFFFFF>%battery% </fc><fc=#666666>| </fc><fc=#ed8bad>%KGDJ% </fc><fc=#666666>| </fc><fc=#8BE9FD>%date%</fc> <fc=#666666>|</fc> <icon=xmonadlogo.xpm/>  "
       }
